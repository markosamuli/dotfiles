...
Check [segments/](https://github.com/suvash/tmux-powerline-osx/tree/master/segments) for more undocumented segments and details.
...
# Installation
Make sure you have the bash version > 4.0 (even though it don't use it)
...
```console
$ cd ~/some/path/
$ git clone git@github.com:suvash/tmux-powerline-osx.git
```
